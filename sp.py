...
EC_INFORMATION = {
    ...
    "re_hei": {"Name": "RE & HEI",
               "Description": category_desc_conf.RE_DESC + "<br /><br />" + category_desc_conf.HEI_DESC},
    "re_nren": {"Name": "RE & NREN",
                "Description": category_desc_conf.RE_DESC + "<br /><br />" + category_desc_conf.NREN_DESC},
    "re_nren_sfs": {
        "Name": "RE & NREN & SFS",
        "Description": category_desc_conf.RE_DESC + "<br /><br />" + category_desc_conf.NREN_DESC +
                       "<br /><br />" + category_desc_conf.SFS_DESC},
    "re_sfs_hei": {
        "Name": "RE & SFS & HEI",
        "Description": category_desc_conf.RE_DESC + "<br /><br />" + category_desc_conf.SFS_DESC + "<br /><br />" +
                       category_desc_conf.HEI_DESC},
}
